# 
# Simple version of vibration sensor program that listen to vibration events.
# If number of vibrations exceeds threshold, it sends notification to ntfy.fy topic
#
